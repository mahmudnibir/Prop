    ...
    <div className="min-h-screen w-full bg-[#F2ECE4] flex flex-col items-center py-4 md:py-8 px-4 no-print-bg">
        ...
        <div className="w-full max-w-2xl flex flex-col items-center justify-start relative print:max-w-none">
            ...
            >
                ...
                <div className="absolute inset-2 sm:inset-4 border-[3.5px] border-[#D4AF37]/80 pointer-events-none"></div>
                <div className="absolute inset-4 sm:inset-6 border-[2px] border-[#D4AF37]/40 pointer-events-none"></div>
                ...
                <div className="relative z-10 flex flex-col h-full print:justify-between">
                    <header className="text-center space-y-1 sm:space-y-3 pt-2 sm:pt-4 mb-4 print:mb-2 print:pt-4">
                        <div className="space-y-0.5 sm:space-y-1">
                            ...
                            <div className="w-12 sm:w-16 h-[2px] sm:h-[3px] bg-[#D4AF37]/80 mx-auto"></div>
                        </div>
                        <h1 className="text-4xl sm:text-6xl md:text-7xl font-cursive text-[#000000] tracking-tight leading-tight drop-shadow-[1px_1px_1px_rgba(0,0,0,0.3)]">
                            A Covenant of Love
                        </h1>
                    </header>
                    ...
                    <section className="space-y-2 sm:space-y-4 text-center mb-6 print:mb-2">
                        ...
                        <div className="space-y-2 sm:space-y-4">
                            ...
                            <div className="text-[#D4AF37] font-serif italic text-lg sm:text-2xl font-bold flex items-center justify-center gap-3">
                                <div className="w-10 sm:w-14 h-[2px] bg-[#D4AF37]/70"></div>
                                <span className="text-black scale-150">&</span>
                                <div className="w-10 sm:w-14 h-[2px] bg-[#D4AF37]/70"></div>
                            </div>
                    ...
                    <div className="relative py-8 px-6 sm:px-12 border-[3.5px] border-[#D4AF37]/70 bg-[#FCF8F2]/70 backdrop-blur-[2px] mx-1 sm:mx-6 mb-6 print:mb-2 print:py-6 shadow-md group">
                        {/* High-Impact Decorative Corner Accents */}
                        <div className="absolute top-0 left-0 w-6 h-6 border-t-4 border-l-4 border-[#D4AF37]"></div>
                        <div className="absolute top-0 right-0 w-6 h-6 border-t-4 border-r-4 border-[#D4AF37]"></div>
                        <div className="absolute bottom-0 left-0 w-6 h-6 border-b-4 border-l-4 border-[#D4AF37]"></div>
                        <div className="absolute bottom-0 right-0 w-6 h-6 border-b-4 border-r-4 border-[#D4AF37]"></div>
                        ...
                        <div className="text-center space-y-1 mb-6 print:mb-4">
                            ...
                            <div className="flex items-center justify-center gap-2">
                                <div className="w-8 h-[2.5px] bg-[#D4AF37]"></div>
                                <HeartIcon className="w-4 h-4 text-[#D4AF37]" />
                                <div className="w-8 h-[2.5px] bg-[#D4AF37]"></div>
                            </div>
                        </div>
                        ...
                        <div className="text-center">
                             <div className="font-serif-classic italic tracking-wide text-[#000000]">
                                <p className="text-[15px] sm:text-[22px] font-bold leading-[1.6] sm:leading-[1.9] max-w-prose mx-auto print:text-[18px] print:leading-[1.7] drop-shadow-[0.2px_0.2px_0px_rgba(0,0,0,0.1)]">
                             ...
                             <div className="pt-8 print:pt-4">
                                <div className="relative inline-block px-12">
                                    <div className="absolute top-1/2 left-0 w-10 h-[2px] bg-[#D4AF37]/80"></div>
                                    ...
                                    <div className="absolute top-1/2 right-0 w-10 h-[2px] bg-[#D4AF37]/80"></div>
                                </div>
                             </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-auto flex flex-col items-start w-full px-6 sm:px-14 pb-8 sm:pb-12 gap-5 sm:gap-8 print:pb-1cm print:mt-4 print:gap-6">
                        <div className="flex flex-col items-start text-left space-y-1 w-full max-w-[280px] sm:max-w-[320px]">
                            <div className="border-b-[3px] border-[#D4AF37]/80 w-full pb-1 relative">
                                <span className="font-cursive text-3xl sm:text-4xl text-[#000000] font-bold drop-shadow-[0.5px_0.5px_0px_rgba(0,0,0,0.2)]">{recipientName}</span>
                                <div className="absolute -bottom-1.5 left-0 w-14 h-[4px] bg-[#D4AF37]"></div>
                            </div>
                        ...
                        <div className="flex flex-col items-start text-left space-y-1 w-full max-w-[280px] sm:max-w-[320px]">
                            <div className="border-b-[3px] border-[#D4AF37]/80 w-full pb-1 relative">
                                <span className="font-cursive text-3xl sm:text-4xl text-[#000000] font-bold drop-shadow-[0.5px_0.5px_0px_rgba(0,0,0,0.2)]">{senderName}</span>
                                <div className="absolute -bottom-1.5 left-0 w-14 h-[4px] bg-[#D4AF37]"></div>
                            </div>
                            <span className="text-[10px] sm:text-[13px] italic font-bold text-[#B48F00] font-serif-classic leading-tight tracking-wide">
